...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { base, reviver, toJSON } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64@v0.2.1-deno/mod.js';
```
