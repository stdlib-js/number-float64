...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/number-float64/tags). For example,

```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64@v0.3.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ns = require( 'path/to/vendor/umd/number-float64/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/number-float64/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/number-float64/actions/workflows/test.yml?query=branch:v0.3.0
...
[@stdlib/number/float64/base]: https://github.com/stdlib-js/number-float64-base/tree/umd

[@stdlib/number/float64/reviver]: https://github.com/stdlib-js/number-float64-reviver/tree/umd
