...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64@umd/bundle.js"></script>
```
